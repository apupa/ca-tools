## La trasformata di Laplace come trasformazione funzionale
...
L'analisi dei sistemi dinamici si avvale della trasformata di Laplace di alcuni segnali fondamentali, detti segnali canonici, che rappresentano sollecitazioni tipiche. L'impulso unitario, o delta di Dirac $\delta(t)$, ha come trasformata il valore unitario $1$. Il gradino unitario $u(t)$, fondamentale per lo studio della risposta a regime e della stabilità, si trasforma in $1/s$, mentre la rampa unitaria $t$ corrisponde a $1/s^2$. Funzioni più complesse come la parabola unitaria $t^2/2$ e l'esponenziale $e^{at}$ hanno come immagini rispettivamente $1/s^3$ e $1/(s-a)$. Anche i segnali sinusoidali e cosinusoidali, pilastri dell'analisi armonica, possiedono trasformate ben definite, $\frac{\omega}{s^2 + \omega^2}$ per il seno e $\frac{s}{s^2 + \omega^2}$ per il coseno. Una relazione di carattere generale permette di ricavare la quasi totalità delle trasformate di interesse corrente:
...
## Numeri complessi e conteggio delle radici del polinomio caratteristico
...
## Definizione e significato della Funzione di Trasferimento (FdT)
...
## Derivazione della FdT dal modello Ingresso-Uscita (IU)
...
## Derivazione della FdT dalla rappresentazione Ingresso-Stato-Uscita (ISU)
